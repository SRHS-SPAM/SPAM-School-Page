                ...
                <div className={style.community_detail_home}>
                    <div className={style.community_detail_upper}>
                            ...
                            <div className={style.selc_func}>
                                ...
                                <div className={style.selc_write}>
                                    ...
                                    <Link href="writing.html">
                                        <div className={style.selc_write_text}>
                                            글쓰기
                                        </div>
                                    </Link>
                                </div>
                        ...
                        <div className={style.writing_class}>
                            <div
                                className={`${style.class_name} ${style.class_num}`}
                            >
                                번호
                            </div>
                            <div
                                className={`${style.class_name} ${style.class_title}`}
                            >
                                제목
                            </div>
                            <div
                                className={`${style.class_name} ${style.class_au}`}
                            >
                                작성자
                            </div>
                            <div
                                className={`${style.class_name} ${style.class_date}`}
                            >
                                작성일
                            </div>
                            <div
                                className={`${style.class_name} ${style.class_view}`}
                            >
                                조회수
                            </div>
                            <div
                                className={`${style.class_name} ${style.class_reco}`}
                            >
                                추천
                            </div>
                        </div>
                            ...
                            <div className={style.writing_footer}>
                                <div className={style.writing_footer_box}>
                                    ...
                                    <div className={style.writing_search}>
                                        <div
                                            className={style.writing_search_box}
                                        >
                                            <div
                                                className={
                                                    style.writing_search_input
                                                }
                                            >
                                                <input type="text" />
                                            </div>
                                    ...
                                    <div className={style.page_selector}>
                                        <div
                                            className={style.page_selector_box}
                                        >
                                            <div
                                                className={
                                                    style.community_pages
                                                }
                                            >
